...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa Nama Cewe Lu:v ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def loginSC():
	...
	if username =="ipul" and password =="ganteng":
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;93mLOGIN AKUN FACEBOOK ANDA Qmak \x1b[1;96m[☆]' )
		...
		if 'checkpoint' in url:
			...
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email salah Qmak")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
